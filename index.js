...
program.version("1.5.3", "-v, --version")
...
program
  ...
  .option(
    "-r, --restURL <restURL>",
    "The rest URL to use. default: https://trest.example.com/v1/"
  )
  .option(
    "-e, --environment <environment>",
    "environment of running WormholeREST instance. Ex: production, staging. (Default: development)"
  )
