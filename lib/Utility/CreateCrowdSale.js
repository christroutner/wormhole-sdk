...
var CreateCrowdSale = function () {
  function CreateCrowdSale(Wormhole) {
    _classCallCheck(this, CreateCrowdSale);

    this.Wormhole = Wormhole;
  }

  _createClass(CreateCrowdSale, [{
    key: "createCrowdSale",
    value: async function createCrowdSale(hdNode, ecosystem, precision, predecessor, category, subcategory, ticker, url, description, identifier, tokensGranted, deadline, bonus, amount) {
      try {
        ...
        var crowdsale = await this.Wormhole.PayloadCreation.crowdsale(ecosystem, precision, predecessor, category, subcategory, ticker, url, description, identifier, tokensGranted, deadline, bonus, 0, amount);
        ...
        var opReturn = await this.Wormhole.RawTransactions.opReturn(rawTx, crowdsale);
  ...
  return CreateCrowdSale;
}();

exports.default = CreateCrowdSale;