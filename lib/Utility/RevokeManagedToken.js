...
var RevokeManagedToken = function () {
  function RevokeManagedToken(Wormhole) {
    _classCallCheck(this, RevokeManagedToken);

    this.Wormhole = Wormhole;
  }

  _createClass(RevokeManagedToken, [{
    ...
    value: async function revokeManagedToken(hdNode, propertyId, tokenQuantity) {
      try {
        ...
        var payload = await this.Wormhole.PayloadCreation.revoke(propertyId, tokenQuantity);
        ...
        var opReturn = await this.Wormhole.RawTransactions.opReturn(rawTx, payload);
  ...
  return RevokeManagedToken;
}();

exports.default = RevokeManagedToken;